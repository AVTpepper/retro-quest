...
scene("game", ({ character, level, score }) => {
  ...
  switch (level) {
    ...
    const maps = [
        ...
        [
            'i          iiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii',
            '£                                                                                                         ',
            '£                                                                                                         ',
            '£                                                                                                         ',
            '£           %=%    $$$$$                                                                                  ',
    ...
    const levelCfg = {
        ...
        /* still needed
        'h': [sprite('platform-h'), solid()],
        'H': [sprite('platform-H'), solid()],
        'v': [sprite('platform-v'), solid()],
        'd': [sprite('block arrow down'), solid()],
        'i': [sprite('block invisible'), solid()],*/
